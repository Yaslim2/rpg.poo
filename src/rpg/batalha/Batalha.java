...
public class Batalha {
	...
	public void Batalhar(List<Personagem> personagens) {
        ...
        try {
           ...
           switch(op){
               case 1:
                   //VERIFICANDO SE EXISTEM MAIS PERSONAGENS DO QUE 1 PARA INICIAR A BATALHA, SE NÃƒÆ’O, A FUNÃƒâ€¡ÃƒÆ’O BATALHAR Ãƒâ€° QUEBRADA
                   if(lutadores.size() <= 1){
                   ...
                   while(true){
                       ...
                       for(int i = 0; i <= tamanho; i++){ // round ja iniciado
                         if(lutadores.get(i).getPontosDeVida() > 0){  
                           ...
                           //VERIFICANDO QUAL OPÃƒâ€¡ÃƒÆ’O O GUERREIRO SELECIONOU
                           switch(atacado){
                               //ATAQUE
                               case 1:
                                   ...
                                   //VERIFICANDO SE EXISTE ALGUM GUERREIRO MORTO PARA NAO SER OPÃƒâ€¡ÃƒÆ’O DE ATAQUE
                                   try{
                                   for(int o = 0; o <= listaDeGuerreiros.size(); o++){
                                       ...
                                       //apenas ignroando o erro que darÃƒÂ¡ de index
                                   }
                                   ...
                                   while(true){
                                       ...
                                       //ARMAZENANDO O GUERREIRO QUE SERÃƒï¿½ ATACADO BASEADO NA ESCOLHA DO INDEX DENTRO DO VETOR LISTADEGUERREIROS
                                       ...
                                       switch(typeOfAtt){
                                           ...
                                           case 1:
                                               ...
                                               switch(tipoAtaquePadrao){
                                                   //ATAQUE PADRÃƒÆ’O COM DANO FÃƒï¿½SICO
                                                   case 1:
                                                       ...
                                                       break;
                                                   //ATAQUE PADRÃƒÆ’O COM PODER DE HABILIDADE
                                                   case 2:
                                           ...
                                           case 2:
                                               //compensar os ataques nas vidas
                                               //exibir os status
                                               //VERIFICAR SE ESTÃƒï¿½ COM A ULT PRONTA SE NAO, OBRIGA O USUARIO A REALIZAR UM ATAQUE PADRÃƒÆ’O PELA FUNÃƒâ€¡ÃƒÆ’O CATCH(TRY)
                                               ...
                                               // 1 - poderDeHabilidadeEspecial
                                                   ...
                                                   //NÃƒÆ’O ACONTECEU, LOGO, CAIRÃƒï¿½ NO CATCH
                                                   try {
                                                        Random gerador = new Random();
                                                        int intensidade = gerador.nextInt(4);
                               ...
                               //TENDO EM VISTA QUE SÃƒâ€œ Ãƒâ€° POSSÃƒï¿½VEL
                               //MORRER UM GUERREIRO POR ROUND, O FOR Ãƒâ€° QUEBRADO.
                               System.out.println("\nSeria a vez do guerreiro " + lutadores.get(i).getNomeChar() + ", mas ele era fraco demais e faleceu. Press f to pay respect!\nPulando a vez!\n\n");
                               System.out.println("Pressione ENTER para continuar...");
                               new java.util.Scanner(System.in).nextLine();
                           }
                       }
                       //INCREMENTANDO OS ROUNDS. O NÃƒÅ¡MERO DE ROUNDS Ãƒâ€° INDETERMINADO POIS A BATALHA SÃƒâ€œ ACABA QUANDO RESTA
                       //UM GUERREIRO VIVO
                       rounds++;   
